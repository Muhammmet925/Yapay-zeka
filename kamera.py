...
yuz_bulma = cv2.CascadeClassifier("Yapay zeka/haarcascade_frontalface_default.xml")
...
while kaynak.isOpened():
    ...
    yuzler = yuz_bulma.detectMultiScale(goruntu_griton, scaleFactor=1.1, minNeighbors=5)
